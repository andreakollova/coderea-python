...
function updateLineNumbers(textarea, lineNumbersDiv) {
    ...
    lineNumbersDiv.innerHTML = Array.from({ length: linesCount }, (_, i) => `<span>${i + 1}</span>`).join('');
...
function displayCard(card) {
    ...
    cardElement.innerHTML = `
        <div class="assignment-area">
            ...
            <span class="card-category">
                <img src="./icons/Lesson-${categories.indexOf(card.category) + 1}.svg" 
        ...
        <div class="explanation-box" style="display: none;">
            ...
            <p class="explanation-content">${card.explanation || 'No explanation available.'}</p>
        </div>
    `;
    ...
    cardElement.querySelector('.coding-area .line-numbers').appendChild(lineNumbersDiv);

    // Add line numbers to the Original Code section
    const originalCodePre = cardElement.querySelector('.original-code pre code');
    const originalLineNumbersDiv = addLineNumbersStatic(originalCodePre.textContent);
    cardElement.querySelector('.original-code .line-numbers').appendChild(originalLineNumbersDiv);
    ...
    cardElement.querySelector('.user-code .line-numbers').appendChild(userLineNumbersDiv);
...
const originalCodeLineNumbersDiv = document.querySelector('.original-code .line-numbers');
...
function updateLogo(theme) {
    headerLogo.src = theme === 'dark' ? './images/logo-dark.png' : './images/logo-light.png';
}
